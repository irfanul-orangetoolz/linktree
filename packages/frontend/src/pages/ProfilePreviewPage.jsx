  ...
  return (
    <div className="min-h-screen bg-gray-100 p-6 flex justify-center">
      <div className="max-w-md w-full bg-white rounded-lg shadow-md p-6">
        <h1 className="text-3xl font-bold text-center mb-6">Profile Preview</h1>
        ...
        <div className="text-center mb-6">
          ...
          <h2 className="text-2xl font-semibold">{preview.name || 'Unnamed'}</h2>
          {preview.bio && <p className="text-gray-600 mt-2">{preview.bio}</p>}
        </div>
        ...
        <div>
          ...
          {preview.socialAccounts && preview.socialAccounts.length > 0 ? (
            <div className="space-y-2">
              {preview.socialAccounts.map((account) => (
                <div
