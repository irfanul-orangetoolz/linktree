...
import CustomLucideIcon from "@/components/logo/LogoV2";
						...
						<div className="flex flex-col md:flex-row items-center gap-12">
							<div className="flex-1 text-center md:text-left">
								...
								<p className="text-lg md:text-xl text-muted-foreground mb-8 max-w-2xl">
									Connect all your social platforms in one
									place. Share your content, grow your
									audience, and track your performance.
								</p>
						...
						<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
							<div className="bg-card p-6 rounded-xl shadow-sm border">
								...
								<p className="text-muted-foreground">
									Create and organize all your important links
									in one place with customizable buttons.
								</p>
							</div>
							...
							<div className="bg-card p-6 rounded-xl shadow-sm border">
								...
								<p className="text-muted-foreground">
									Connect and display content from all your
							...
							<div className="bg-card p-6 rounded-xl shadow-sm border">
								...
								<p className="text-muted-foreground">
									Increase followers and engagement with a
									professional profile page that showcases all
									your content.
								</p>
							</div>
							...
							<div className="bg-card p-6 rounded-xl shadow-sm border">
								...
								<p className="text-muted-foreground">
									Your profile looks great on all devices,
								...
								<div className="flex flex-col md:flex-row gap-6 items-center">
									<div className="flex-1">
										...
										<p className="text-muted-foreground mb-4">
											...
											growing their audience with our
											platform.
										</p>
										<Button asChild>
											<Link to="/register">
					...
					<div className="container mx-auto max-w-6xl">
						<div className="grid grid-cols-1 md:grid-cols-2 gap-8">
							<div>
								...
								<p className="text-muted-foreground max-w-md">
									The all-in-one platform for creators to
									showcase their social media presence and
									manage their links.
								</p>
							</div>
						...
						<div className="mt-12 pt-8 border-t">
							<p className="text-center text-muted-foreground text-sm">
								© {new Date().getFullYear()} SocialNexus. All
								rights reserved.
							</p>
						</div>
					</div>
