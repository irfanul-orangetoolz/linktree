...
module.exports = {
  ...
  down: async (queryInterface, Sequelize) => {
    ...
    await queryInterface.removeIndex('social_media_accounts', 'idx_social_user_id');
    await queryInterface.removeIndex('social_media_accounts', 'idx_social_platform');
    ...
    await queryInterface.removeIndex('analytics', 'idx_analytics_timestamp');
